...
from controllers import HomeController, ArticlesController, ArticleDetailController, ArticleDeleteController, \
...
if __name__ == '__main__':
    ...
    app.add_route(r'^articles/(\d+)/delete/$', ArticleDeleteController(methods=['GET', 'POST']))
    app.add_route(r'^articles/(\d+)/edit/$', ArticleEditController(methods=['GET', 'POST']))
    app.add_route(r'^articles/(\d+)/$', ArticleDetailController(methods=['GET']))
